...
public class BasicExpandControl implements ExpandControl, UIResource
{
    ...
    public function paintExpandControl(c:Component, g:Graphics2D, bounds:IntRectangle, totalChildIndent:int, path:TreePath, row:int, expanded:Boolean, leaf:Boolean):void
    {
        if (leaf)
        {
            return;

...
public class DefaultTreeModel implements TreeModel
{
     ...
     */
    private function fireTreeNodesChanged(source:Object, path:Array, childIndices:Array, children:Array):void
    {
     ...
     * @see EventListenerList
     */
    private function fireTreeNodesInserted(source:Object, path:Array, childIndices:Array, children:Array):void
    {
        var listeners:Array = listenerList;
        var e:TreeModelEvent = null;
        // Process the listeners last to first, notifying
     ...
     * @see EventListenerList
     */
    private function fireTreeNodesRemoved(source:Object, path:Array, childIndices:Array, children:Array):void
    {
        var listeners:Array = listenerList;
        var e:TreeModelEvent = null;
        // Process the listeners last to first, notifying
     ...
     * @see EventListenerList
     */
    private function fireTreeStructureChanged(source:Object, path:Array, childIndices:Array, children:Array):void
    {
        var listeners:Array = listenerList;
        var e:TreeModelEvent = null;
        // Process the listeners last to first, notifying

...
public class JFrame extends JWindow{
	 ...
	 * 
	 * <p>"dragable" means drag to relocate the frame.
	 * @param b 
	 * @see #isDragable()
	 */
	...
	/**
	 * Indicate whether need relocate frame directly when drag the frame.
	 * if set to false, there will be a rectange to represent then bounds what will be relocate to.
	 * if set to true, the frame will be relocate directly when drag, but this is need more cpu counting.<br>
	 * Default is false.
	 */	
	...
	/**
	 * Return whether need relocate frame directly when drag the frame.
	 * @see #setDragDirectly()
	 */	
